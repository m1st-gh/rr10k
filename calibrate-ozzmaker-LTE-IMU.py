...
def handle_ctrl_c(signal, frame):
    with open('magnetometer_values.txt', 'w') as file:
        file.write(str(magXmin) + '\n')
        file.write(str(magYmin) + '\n')
        file.write(str(magZmin) + '\n')
        file.write(str(magXmax) + '\n')
        file.write(str(magYmax) + '\n')
        file.write(str(magZmax) + '\n')
